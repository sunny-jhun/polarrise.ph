                    ...
                    <table class="table table-bordered content-table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="hidden-xs"><a href="/admin/inventory/categories/{{ $category->id }}" class="btn btn-primary btn-flat">Show Products</a><a href="/admin/inventory/categories/{{$category->id}}/edit" class="btn btn-primary btn-flat">Edit</a><input type="button" class="btn bg-red btn-flat delete" value="Delete">
