            ...
            <form action="{{ action('Admin\Inventory\SupplierController@store') }}" method="post">
                ...
                <div class="form-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                            <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="ex. Sunny Jhun Ibabao">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="contact_number" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 col-form-label">Contact Number</label>
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                            <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="ex. 0977xxxxxxx">
                        </div>
                    </div>
                </div>
            </form>
